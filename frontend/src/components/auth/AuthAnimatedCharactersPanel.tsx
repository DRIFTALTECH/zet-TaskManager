...
export interface AuthAnimatedCharactersPanelProps {
  header: ReactNode;
  password: string;
...
export function AuthAnimatedCharactersPanel({
  header,
  password,
  showPassword,
  isTyping,
}: AuthAnimatedCharactersPanelProps) {
  const [mouseX, setMouseX] = useState(0);
  const [mouseY, setMouseY] = useState(0);
  ...
  return (
    <div className="relative hidden lg:flex flex-col justify-between bg-gradient-to-br from-primary/90 via-primary to-primary/80 p-12 text-primary-foreground">
      <div className="relative z-20 text-lg font-semibold">{header}</div>
